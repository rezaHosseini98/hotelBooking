...
const RoomDetails = () => {
  ...
  return (
    room && (
      <div className="py-28 md:py-35 px-4 md:px-16 lg:px-19 xl:px-32">
        {/* Room Detail */}
        <div className="flex flex-col md:flex-row items-start md:items-center gap-2">
          <h1 className="text-3xl md:text-4xl font-playfair">
            {room.hotel.name}{" "}
            <span className="font-inter text-xs">({room.roomType})</span>
          </h1>
          <p className="bg-orange-500 rounded-full font-inter py-1.5 px-3 text-white text-xs">
            20% OFF
          </p>
        </div>
        {/* Room Rating */}
